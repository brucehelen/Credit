...
- (void)setLastUpdatedTimeKey:(NSString *)lastUpdatedTimeKey
{
    ...
    if (lastUpdatedTime) {
        ...
        // 3.显示日期
        self.lastUpdatedTimeLabel.text = [NSString stringWithFormat:@"%@%@", kLoadStringWithKey(@"MJRefresh_last_update"), time];
    } else {
        self.lastUpdatedTimeLabel.text = kLoadStringWithKey(@"MJRefresh_last_update_no_record");
    }
}
